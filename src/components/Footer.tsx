...
export default function Footer() {
  return (
    <footer className="w-full border-t bg-background/20 backdrop-blur-lg shadow p-4">
      <div className="container mx-auto flex items-center gap-6 text-sm text-muted-foreground">
        <Image src="/logo.svg" alt="WULKAN Logo" width={40} height={40} className="absolute" />
